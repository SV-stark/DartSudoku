    ...
    return [
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'Candidates 3 and 8 appear only in Col 1 and 5 of Row 1 (Hidden Pair). This eliminates other candidates from these cells, including candidate 4 from Row 1 Col 1. Now, in Column 1, candidate 4 can only go in Row 2 Col 1. Input 4.',
            board: emptyBoard(),
            highlightedRow: 1,
            highlightedCol: 0,
            notes: {
            ...
            expectedValue: 4,
            interactiveHelp:
                'The hidden pair {3, 8} in Row 1 eliminates candidate 4 from Row 1 Col 1, leaving Row 2 Col 1 as the only cell in Column 1 that can contain 4.',
            customHighlights: (context) => {
              '0,0': helperColor,
              '0,4': helperColor,
              '1,0': targetColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'Candidates {1, 5, 9} appear only in Col 1, 5, and 9 of Row 1 (Hidden Triple). This eliminates other candidates from these cells, including candidate 6 from Row 1 Col 9. Now, in Column 9, candidate 6 can only go in Row 2 Col 9. Input 6.',
            board: emptyBoard(),
            highlightedRow: 1,
            highlightedCol: 8,
            notes: {
            ...
            expectedValue: 6,
            interactiveHelp:
                'The hidden triple {1, 5, 9} in Row 1 eliminates candidate 6 from Row 1 Col 9. This leaves Row 2 Col 9 as the only cell in Column 9 that can contain 6.',
            customHighlights: (context) => {
              '0,0': helperColor,
              '0,4': helperColor,
              '0,8': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'Candidates {1, 3, 7, 8} appear only in Col 1, 3, 6, and 8 of Row 1 (Hidden Quadruple). This eliminates other candidates from these cells, including candidate 4 from Row 1 Col 1. Now, in Column 1, candidate 4 can only go in Row 2 Col 1. Input 4.',
            board: emptyBoard(),
            highlightedRow: 1,
            highlightedCol: 0,
            notes: {
            ...
            expectedValue: 4,
            interactiveHelp:
                'The hidden quadruple {1, 3, 7, 8} in Row 1 eliminates candidate 4 from Row 1 Col 1. This leaves Row 2 Col 1 as the only cell in Column 1 that can contain 4.',
            customHighlights: (context) => {
              '0,0': helperColor,
              '0,2': helperColor,
              '0,5': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'The X-Chain links Row 1 Col 2 to Row 9 Col 5. Row 9 Col 2 sees both endpoints, eliminating 4 and leaving 1! Input 1.',
            board: emptyBoard(),
            highlightedRow: 8,
            highlightedCol: 1,
            notes: {
            ...
            expectedValue: 1,
            interactiveHelp:
                'Candidate 4 must be in either Row 1 Col 2 or Row 9 Col 5, so it is eliminated from Row 9 Col 2.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '5,7': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'All three branches of implication starting from Row 4 Col 4 ({1, 2, 3}) converge to force Row 6 Col 6 to be 9! Input 9.',
            board: emptyBoard(),
            highlightedRow: 5,
            highlightedCol: 5,
            notes: {
            ...
            expectedValue: 9,
            interactiveHelp:
                'Every possible candidate state for Row 4 Col 4 leads directly to 9 in Row 6 Col 6.',
            customHighlights: (context) => {
              '3,3': alertColor,
              '3,4': helperColor,
              '4,3': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'If Row 3 Col 8 is 3 or 8, it creates a non-unique deadly loop. Therefore, Row 3 Col 8 must be 5! Input 5.',
            board: emptyBoard(),
            highlightedRow: 2,
            highlightedCol: 7,
            notes: {
            ...
            expectedValue: 5,
            interactiveHelp:
                'To avoid a non-unique deadly loop of {3, 8}, Row 3 Col 8 must be the extra candidate 5.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '2,1': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'Candidate 5 must appear in Row 3 Col 2 or Row 3 Col 8. This eliminates 5 from Row 3 Col 5, leaving only 9! Input 9.',
            board: emptyBoard(),
            highlightedRow: 2,
            highlightedCol: 4,
            notes: {
            ...
            expectedValue: 9,
            interactiveHelp:
                'Since 5 is locked in Row 3 of the rectangle, candidate 5 is eliminated from Row 3 Col 5.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '2,1': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'The extra candidates {1,2} form a Naked Pair in Row 3 with Row 3 Col 5. This eliminates 1 from Row 3 Col 9, leaving only 6! Input 6.',
            board: emptyBoard(),
            highlightedRow: 2,
            highlightedCol: 8,
            notes: {
            ...
            expectedValue: 6,
            interactiveHelp:
                'The naked pair of {1, 2} in Row 3 eliminates candidate 1 from Row 3 Col 9.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '2,1': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'Since candidate 8 is locked in Row 3 of the rectangle, candidate 3 is eliminated from Row 3 Col 8. Row 3 Col 8 must be 8! Input 8.',
            board: emptyBoard(),
            highlightedRow: 2,
            highlightedCol: 7,
            notes: {
            ...
            expectedValue: 8,
            interactiveHelp:
                'Eliminating 3 from Row 3 Col 8 leaves 8 as the only possible candidate.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '2,1': helperColor,
      ...
      LessonData(
        ...
        slides: [
          ...
          SlideData(
            text:
                'To avoid a deadly pattern of {3, 8}, candidate 5 must be true in at least one of the three cells: Row 1 Col 2, Row 2 Col 2, or Row 2 Col 8. Cell Row 2 Col 3 sees all three cells, so candidate 5 is eliminated from it, leaving 9! Input 9.',
            board: emptyBoard(),
            highlightedRow: 1,
            highlightedCol: 2,
            notes: {
            ...
            expectedValue: 9,
            interactiveHelp:
                'Since 5 must be in at least one of the three cells containing it in the rectangle, it is eliminated from Row 2 Col 3, leaving only 9.',
            customHighlights: (context) => {
              '0,1': helperColor,
              '0,7': helperColor,
              '1,1': helperColor,
